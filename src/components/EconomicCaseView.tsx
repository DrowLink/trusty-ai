    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 space-y-12 font-sans">
      ...
      <div className="border-b border-slate-800/80 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          {/* Card 1: Data Lookup */}
          <div className="rounded-xl bg-[#090d16] border border-slate-800 p-6 flex flex-col justify-between relative overflow-hidden">
            <div className="space-y-4">
              ...
              <div className="text-xs font-mono text-slate-400">
                Typical value: <span className="text-slate-300 font-semibold">cents per query</span>
              </div>
            </div>

            <div className="mt-8 pt-4 border-t border-slate-800/80 flex items-baseline justify-between">
              <div>
                <div className="text-2xl sm:text-3xl font-black font-mono text-slate-300">
                  1M lookups
                </div>
              ...
              <span className="px-2.5 py-1 rounded bg-slate-800/60 border border-slate-700/60 text-[10px] font-mono text-slate-400">
                Passive Lookup
              </span>
            </div>
          </div>

          {/* Card 2: Risk Decision (Hero highlighted) */}
          <div className="rounded-xl bg-[#09101c] border border-sky-500/50 p-6 flex flex-col justify-between relative shadow-xl shadow-sky-950/20">
            <div className="absolute top-0 right-0 px-3 py-1 bg-sky-500/10 border-b border-l border-sky-500/30 rounded-bl text-[10px] font-mono text-sky-300 font-bold uppercase tracking-wider">
              Core Economic Moat
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="inline-flex items-center space-x-2 text-xs font-mono text-emerald-400 font-bold">
                <span>APPROVE</span>
                <span>/</span>
            ...
            <div className="mt-8 pt-4 border-t border-sky-500/30 flex items-baseline justify-between">
              <div>
              ...
              <button
                ...
                className="px-3 py-1.5 rounded bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold text-xs font-mono transition flex items-center space-x-1"
              >
      ...
      <div className="space-y-6">
        ...
        {/* Highlight Box: 5 Basis Points of Volume */}
        <div className="p-6 rounded-xl bg-gradient-to-r from-slate-900 via-[#0a1220] to-slate-900 border border-sky-900/50 shadow-lg">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          {/* Engine 1 */}
          <div className="p-4 sm:p-5 rounded-xl bg-[#090d16] border border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start space-x-3">
              <div className="w-7 h-7 rounded bg-emerald-950/80 border border-emerald-700/60 text-emerald-400 font-mono text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                1
              </div>
              <div>
            ...
            <div className="text-xl sm:text-2xl font-black font-mono text-emerald-400 tabular-nums self-end sm:self-auto">
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-[#090d16] border border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start space-x-3">
              <div className="w-7 h-7 rounded bg-sky-950/80 border border-sky-700/60 text-sky-400 font-mono text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                2
              </div>
              <div>
                <div className="text-sm font-bold text-white font-mono uppercase tracking-wide">
            ...
            <div className="text-xl sm:text-2xl font-black font-mono text-sky-400 tabular-nums self-end sm:self-auto">
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-[#090d16] border border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start space-x-3">
              <div className="w-7 h-7 rounded bg-purple-950/80 border border-purple-700/60 text-purple-400 font-mono text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                3
              </div>
              <div>
                <div className="text-sm font-bold text-white font-mono uppercase tracking-wide">
            ...
            <div className="text-xl sm:text-2xl font-black font-mono text-purple-400 tabular-nums self-end sm:self-auto">
        ...
        {/* Summary ROI Bar */}
        <div className="p-6 rounded-xl bg-[#070e17] border border-emerald-500/40 grid grid-cols-2 md:grid-cols-4 gap-6">
          <div>
            <div className="text-[10px] font-mono uppercase tracking-widest text-slate-400">
          ...
          <div>
            ...
            <div className="text-2xl sm:text-3xl font-black font-mono text-emerald-300 mt-1">
      ...
      <div className="space-y-6">
        <div className="border-b border-slate-800/80 pb-4">
          <div className="text-[11px] font-mono uppercase tracking-widest text-purple-400 font-semibold">
        ...
        <div className="space-y-4">
          ...
          <div className="p-5 rounded-xl bg-slate-900/50 border border-slate-800 space-y-2">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 text-xs sm:text-sm font-mono text-slate-300">
              <span className="p-2 rounded bg-rose-950/40 border border-rose-900/60 text-rose-300 text-center w-full sm:w-auto">
                Allow agents freely &rarr; <strong className="text-rose-200">More Risk</strong>
              </span>
              <span className="text-slate-400 font-bold">OR</span>
              <span className="p-2 rounded bg-amber-950/40 border border-amber-900/60 text-amber-300 text-center w-full sm:w-auto">
                Require conservative limits &rarr; <strong className="text-amber-200">Less Autonomy</strong>
              </span>
            </div>
          </div>

          {/* With */}
          <div className="p-5 rounded-xl bg-[#091515] border border-emerald-500/40 space-y-3">
            <div className="text-[11px] font-mono text-emerald-400 uppercase tracking-widest font-bold flex items-center justify-between">
              <span>WITH TRUSTY (GRANULAR RISK-ADJUSTED CAPACITIES)</span>
              <span className="text-[10px] text-emerald-300 font-normal">Real-Time Decision Path</span>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 font-mono text-xs">
              <div className="p-2.5 rounded bg-slate-950 border border-slate-800 text-slate-300">
                <span className="text-slate-400">Agent A (Thin File):</span> <strong className="text-white">$100/day</strong>
              </div>
              <div className="p-2.5 rounded bg-slate-950 border border-slate-800 text-slate-300">
                <span className="text-slate-400">Agent B (Standard):</span> <strong className="text-white">$5K/day</strong>
              </div>
              <div className="p-2.5 rounded bg-slate-950 border border-slate-800 text-slate-300">
                <span className="text-slate-400">Agent C (Tier AA):</span> <strong className="text-emerald-400">$25K/day</strong>
              </div>
            </div>
            <div className="text-xs font-mono text-slate-300">
              Each individual transaction evaluated: <span className="text-emerald-400 font-bold">APPROVE</span> / <span className="text-rose-400 font-bold">DECLINE</span> / <span className="text-amber-400 font-bold">HUMAN REVIEW</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
          <div className="p-5 rounded-xl bg-[#090d16] border border-slate-800 space-y-1">
          ...
          <div className="p-5 rounded-xl bg-gradient-to-r from-sky-950/40 to-[#0b101c] border border-sky-800/60 space-y-1">
